...
def processImageData(data_folder, dataset, limit):
    ...
    imgFeatExt = ImgFeatureExtractor(
        imgDim, color_space, resizeFac, dataDir, imgDataDir, inputDataDir, learnSet
    )
    __ = imgFeatExt.resizeAndConcatenate(
        coordFileName, limit, use_high_pass_filter=True
    )
