...
if "img" in args.input:
    ...
    method = 1
    # train
    img_train_input_file = (
        data_dir + "image_input/img_input_train_" + str(resizeFac) + ".npz"
    )
    ...
    # validation
    img_validation_input_file = (
        data_dir + "image_input/img_input_validation_" + str(resizeFac) + ".npz"
    )
